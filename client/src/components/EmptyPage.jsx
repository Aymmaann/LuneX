  ...
  return (
    <div className='w-full p-16 flex items-center justify-center '>
        <div className='bg-darkBlue p-6 rounded-lg border border-zinc-800 text-center'>
            ...
            <div className='bg-mediumBlue w-full  rounded-t-lg p-5'>
            ...
            <Link to="/market">
            <button className='mt-6 py-2 px-4 bg-zinc-200 text-darkBlue rounded-md smoothTransition font-medium text-sm hover:bg-zinc-300 hover:cursor-pointer'>Browse Market</button>
            </Link>
        </div>
    </div>
  )
