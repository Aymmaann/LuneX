    ...
    return (
        <div>
            <div className='flex justify-between items-center'>
                ...
                <assets.FaCloudArrowDown className={`text-[20px] cursor-pointer ${isSaved ? 'text-green-500' : 'text-zinc-500'}`} onClick={handleSave} />
            </div>
            ...
            <div className="flex items-center gap-1 mt-2 justify-start">
                <div className={`rounded-md p-1 ${crypto.price_change_percentage_24h >= 0 ? 'bg-[#0d2218]' : 'bg-[#240d16]'}`}>
                ...
                <p className={`font-medium text-sm ${crypto.price_change_percentage_24h >= 0 ? 'text-[#43e643]' : 'text-[#ec3e44]'}`}>
